...
ESX.RegisterUsableItem('chips', function(source)
	...
	TriggerClientEvent('AliReza:PlaySund_khordan', source)
end)	
...
ESX.RegisterUsableItem('macka', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onEat', source, "prop_ld_snack_01")
	TriggerClientEvent('esx:showNotification', source, "Shoma yek Pasta khordid")
	TriggerClientEvent('AliReza:PlaySund_khordan', source)
end)
...
ESX.RegisterUsableItem('scope', function(source)
    TriggerClientEvent('esx_customItems:usescope', source)
end)
