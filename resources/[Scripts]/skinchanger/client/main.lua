local Components = {
  ...
  {label = _U('bags_1'),             name = 'bags_1',     value = 0,  min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
  {label = _U('bags_2'),             name = 'bags_2',     value = 0,  min = 0,  zoomOffset = 0.6,   camOffset = 0.65, textureof = 'bags_1'}, --
}
