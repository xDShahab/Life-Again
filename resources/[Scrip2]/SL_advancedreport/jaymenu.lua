...
local function drawTitle()
    if menus[currentMenu] then
		...
		if menus[currentMenu].titleFont == "!sprite!" then
			...
			--print("tESX:"..textDict.." spr:"..sprite.." col:"..color.r..","..color.g..","..color.b..","..color.a)
			RequestStreamedTextureDict(textDict, false)
...
function JayMenu.CreateMenu(id, title, closeCallback)
    ...
    menus[id].currentOption = 5
    menus[id].maxOptionCount = 12

    menus[id].titleFont = 2
    menus[id].titleColor = {55, 55, 255, 255}
    menus[id].titleBackgroundColor = {55, 55,55, 255}
