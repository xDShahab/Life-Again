...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, dadgostari,  sheriff, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, taxi = taxi, dadgostari = dadgostari ,  mechanic = mechanic, sheriff = sheriff, player_count = players}
	})
