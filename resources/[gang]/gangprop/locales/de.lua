Locales['de'] = {
  ...
  -- Notifications
  ['from'] = ' von ',
  ['you_have_confinv'] = 'du hast x konfesziert',
  ['confinv'] = ' hat von dir x konfesziert',
  ['you_have_confdm'] = 'du hast $ konfesziert',
  ['confdm'] = ' hat von dir $ konfesziert',
  ['you_have_confweapon'] = 'du hast x1 konfesziert',
  ['confweapon'] = ' hat von dir x1 konfesziert',
