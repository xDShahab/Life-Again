Locales['fr'] = {
  ...
  -- Notifications
  ['from'] = ' à ',
  ['you_have_confinv'] = 'vous avez confisqué x',
  ['confinv'] = ' vous a confisqué x',
  ['you_have_confdm'] = 'vous avez confisqué $',
  ['confdm'] = ' vous a confisqué $',
  ['you_have_confweapon'] = 'vous avez confisqué x1 ',
  ['confweapon'] = ' vous a confisqué x1 ',
