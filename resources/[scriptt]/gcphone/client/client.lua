...
function ShowNoPhoneWarning () 
  ...
  ESX.ShowNotification("Shoma ~r~goshi~s~ nadarid!")
end  
...
function sendMessage(num, message)
  TriggerServerEvent('gcPhone:sendMessagejlland', num, message)
end
...
RegisterNUICallback('sendMessage', function(data, cb)
  ...
  TriggerServerEvent('gcPhone:sendMessagejlland', data.phoneNumber, data.message)
end)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  while takePhoto do
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      ...
      -- end)
      takePhoto = false
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/956695909230583838/oqsftwU5AlIztvzJ74pFT4r0WnGKYjcLLV-t4-aUWZ4BYltmOsONIQiBxHxOh4xqU35X", "files[]", function(data) 
