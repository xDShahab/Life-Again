...
function OpenVehicleShop()
    ...
    cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 115.86, -1510.73, 31.36, 252.063, 15.0, 20.1, 70.00, false, 0)
    PointCamAtCoord(cam, 119.63, -1513.38, 29.48)

    SetCamActive(cam, true)
    RenderScriptCams(true, true, 1, true, true)
        
    SetFocusPosAndVel(115.86, -1510.73, 31.36, 0.0, 0.0, 0.0)
...
function updateSelectedVehicle(model)
  ...
  lastSelectedVehicleEntity = CreateVehicle(hash, 119.63, -1513.38, 29.48, 176.34, 0, 1)
...
RegisterNUICallback(
    ...
    function(data, cb)        
        if Config.TestDrive then
            ...
            testDriveEntity = CreateVehicle(hash, 1073.89, 3016.66, 41.43, 286.86, 0, 0)
