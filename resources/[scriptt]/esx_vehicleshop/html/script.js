    ...
    $('#closemenu').append(`
        ...
        <div class="modal-footer">
            <div class="modal-price">
                <p class='price sale'>$ ` + vehicleSelected.sale / 1 + `</p>
                <p class='price discount'> ` + Math.floor(vehicleSelected.sale / 20000) + ` btc</p>                  
            </div>
            <div class="modal-buttons">     
                ...
                <div>
                    <span>BTC</span>
                    <button id="btc" class="modal-btc button" onclick="buyVehicle('confirm2')" >
                    <img src='images/bitcoin.png' width=34 height=34 style="vertical-align: middle;">
                    </button>
                </div>
                <div>
                    <span>Cancel</span>
...
function buyVehicle(option) {
    ...
    switch (option) {
        case 'cancel':
            break;
        case 'confirm2':
            $.post('http://esx_vehicleshop/Buy2', JSON.stringify(vehicleSelected));
            break;
        case 'confirm':
        ...
        case 1:
            ...
            if (!itemDisabled) {
                ...
                if (dataCar[7].outerText < 1) {
                    document.getElementById("buttonbuy").innerHTML = '<span class="sold-out-text">Satıldı</span>';
                }
            }
            break;
    }
