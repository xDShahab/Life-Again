...
-- shx_rpv2 için veritabanı yapısı dökülüyor

-- shx_rpv2.owned_vehicles: ~69 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `owned_vehicles` DISABLE KEYS */;
/*!40000 ALTER TABLE `owned_vehicles` ENABLE KEYS */;

-- tablo yapısı dökülüyor shx_rpv2.vehicles
...
-- shx_rpv2.vehicles: ~225 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `vehicles` DISABLE KEYS */;
INSERT INTO `vehicles` (`name`, `model`, `price`, `category`, `stock`) VALUES
	('Adder', 'adder', 200000, 'super', 999908),
	('Akuma', 'akuma', 15000, 'motorcycles', 1),
	('Alpha', 'alpha', 100000, 'sports', 0),
	...
	('Banshee', 'banshee', 90000, 'sports', 0),
	...
	('Bifta', 'bifta', 18000, 'offroad', 0),
	('Bison', 'bison', 250000, 'vans', 0),
	('BJXL', 'bjxl', 150000, 'suvs', 0),
	('Blade', 'blade', 50000, 'muscle', 1),
	('Blista', 'blista', 50000, 'compacts', 2),
	('Blista S', 'blista2', 60000, 'sports', 0),
	('Blista GT', 'blista3', 65000, 'sports', 2),
	('Bobcatxl', 'bobcatxl', 300000, 'vans', 1),
	...
	('Btype S', 'btype3', 99000, 'sportsclassics', 1),
	...
	('Camper', 'camper', 60000, 'vans', 1),
	('Carboni', 'carbonizzare', 195000, 'sports', 1),
	('Carbonr S', 'carbonrs', 31200, 'motorcycles', 0),
	('Casco', 'casco', 42000, 'sportsclassics', 0),
	('Cavalcade', 'cavalcade', 92000, 'suvs', 1),
	('Cheetah', 'cheetah', 2500000, 'super', 1),
	('Cheetah SC', 'cheetah2', 2800000, 'sportsclassics', 1),
	('Chino', 'chino', 70000, 'muscle', 0),
	('Chino S', 'chino2', 75000, 'muscle', 1),
	('Cliff hanger', 'cliffhanger', 15800, 'motorcycles', 2),
	('COG55', 'cog55', 210000, 'sedans', 0),
	('Cogcabrio', 'cogcabrio', 70000, 'coupes', 1),
	('Cognoscenti', 'cognoscenti', 200000, 'sedans', 1),
	('Comet SX', 'comet2', 120000, 'sports', 0),
	('Contender', 'contender', 300000, 'suvs', 0),
	('Coquette', 'coquette', 75000, 'sports', 0),
	('Coquette SC', 'coquette2', 74000, 'sportsclassics', 0),
	('Coquette GM', 'coquette3', 80000, 'muscle', 0),
	('Cyclone', 'cyclone', 3000000, 'super', 0),
	...
	('Dominator', 'dominator', 55000, 'muscle', 1),
