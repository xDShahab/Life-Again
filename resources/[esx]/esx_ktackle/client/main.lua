...
local tackAliatctimAnim			= 'mic_2_ig_11_intro_p_one'
...
AddEventHandler('esx_kekke_tackle:getTackled', function(target)
	...
	TaskPlayAnim(playerPed, tackleLib, tackAliatctimAnim, 8.0, -8.0, 3000, 0, 0, false, false, false)
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlPressed(0, Keys['LEFTSHIFT']) and IsControlPressed(0, Keys['G']) and not isTackling and GetGameTimer() - lastTackleTime > 10 * 1000 and not ESX.GetPlayerData().IsDead then
