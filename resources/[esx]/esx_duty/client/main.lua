...
AddEventHandler('esx_duty:hasEnteredMarker', function (zone)
  ...
  elseif zone == 'WeazelDuty' then
    ...
    CurrentActionMsg  = _U('duty')
    CurrentActionData = {}
  elseif zone == 'DadghahDuty' then
    CurrentAction     = 'Dadghah_duty'
    CurrentActionMsg  = _U('duty')
    CurrentActionData = {}
  end
end)
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0, Keys['E']) then
        ...
        elseif CurrentAction == 'police_duty' then
		  ...
		  elseif CurrentAction == 'sheriff_duty' then
          if PlayerData.job.name == 'sheriff' or PlayerData.job.name == 'offsheriff' then
            TriggerServerEvent('duty:sheriff' , GetPlayerServerId(PlayerId()))
            print('slm')
        ...
        elseif CurrentAction == 'Dadghah_duty' then
          if PlayerData.job.name == 'dadgostari' or PlayerData.job.name == 'offdadgostari' then
            TriggerServerEvent('Daddag:dutyy' , GetPlayerServerId(PlayerId()))
        ...
        elseif CurrentAction == 'mechanic_duty' then
          ...
          if PlayerData.job.name == 'mechanic' or PlayerData.job.name == 'offmechanic' then
            ...
            sendNotification("Shoma mechanic nistid!", 'error', 5000)
            Wait(1000)
          end
