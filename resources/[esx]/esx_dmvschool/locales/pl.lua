Locales['pl'] = {
  ...
  ['stop_for_ped'] = 'Stop przejście dla pieszych',
  ['good_lets_cont'] = 'Świetnie, kontynuuj.',
  ['stop_look_left'] = 'Stop spójrz w lewo. Ograniczenie prędkości: %s km/h',
  ['good_turn_right'] = 'Świetnie, skręć w prawo i podążaj za linią',
  ['watch_traffic_lightson'] = 'obserwuj ruch uliczny i  włącz światła!',
  ['stop_for_passing'] = 'Stop przepuść przejeżdźające pojazdy!',
  ['hway_time'] = 'czas na autostradę! Ograniczenie prędkości: %s km/h',
  ['gratz_stay_alert'] = 'jestem pod wrażeniem, ale nie zapomnij się zatrzymać  alert podczas jazdy!',
