Locales['fi'] = {
  ...
  ['stop_for_ped'] = 'Pysähdy katso tietä ylittäviä  jalankulikijoita',
  ['good_lets_cont'] = 'Hyvä, jatkakaa.',
  ['stop_look_left'] = 'Pysähdy ja katso vasemmalle. Nopeusrajoitus: %s km/h',
  ...
  ['stop_for_passing'] = 'Pysähdy ohi menevien autojen vuoksi',
  ['hway_time'] = 'on aika mennä moottoritielle. Nopeusrajoitus: %s km/h',
  ['gratz_stay_alert'] = 'onnitelut, ole tarkkana kun ajat!',
  ['passed_test'] = 'sinä läpäisit kokeen',
  ['failed_test'] = 'sinä epäonnistuit kokeessa',
  ...
  ['driving_too_fast'] = 'Ajat liian nopeeta! Hidasta! Nopeusrajoitus: %s km/h!',
  ['errors'] = 'mistakes: %s/%s',
