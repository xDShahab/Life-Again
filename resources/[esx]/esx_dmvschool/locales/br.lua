Locales['br'] = {
  ...
  ['stop_for_ped'] = 'Pare para o pedestre atravessar o cruzando',
  ['good_lets_cont'] = 'Boa, vamos continuar.',
  ['stop_look_left'] = 'Pare and look left. Limite de velocidade: %s km/h',
  ['good_turn_right'] = 'Boa, vire à direita e siga a em frente',
  ['watch_traffic_lightson'] = 'observe o trânsito e acenda suas luzes!',
  ['stop_for_passing'] = 'Pare olher para um lado e para o outro e veja ser não tem veículos passando!',
  ['hway_time'] = 'é hora de dirigir na auto-estrada! Limite de velocidade: %s km/h',
  ['gratz_stay_alert'] = 'Estou impressionado, mas não se esqueça de ficar alerta enquanto dirigindo!',
  ['passed_test'] = 'você passou no teste, parabéns!',
  ['failed_test'] = 'você falhou no teste, melhor sorte da próxima vez!',
  ...
  ['driving_too_fast'] = 'Você está dirigindo rápido demais o limite de velocidade atual é: %s km/h!',
  ['errors'] = 'erros: %s/%s',
