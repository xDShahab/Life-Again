Locales['fr'] = {
  ...
  ['stop_for_ped'] = 'faite rapidement un stop pour le piéton qui traverse',
  ['good_lets_cont'] = 'Bien! continuons!',
  ['stop_look_left'] = 'marquer rapidement un stop et regardez à votre gauche. Vitesse limite: %s km/h',
