...
Config = {
    ...
    Furniture = { 
        ...
        ['electronics'] = {
            {'tv', 'ex_prop_ex_tv_flat_01', 850},
            {'Flat tv', 'prop_tv_flat_02', 750},
            {'Fat tv 2', 'prop_tv_06', 350},
...
Strings = {
    ['Press_E'] = '~INPUT_CONTEXT~ baraye %s',
    ['Furniture_Categories'] = 'Categories',
    ['Manage_House'] = 'LifeAgain HOUSE MENU',
    ['Buy_House'] = 'خرید خونه به قیمت #%s',
    ['Knock_House'] = 'dar zadan',
    ['Your_House'] = 'Your house',
    ['Buyable_House'] = 'Buyable house',
    ['Player_House'] = 'Player house',
    ['Storage'] = ' dastresi be inventory khone',
    ['Sell_House'] = 'فروخت خونه به قیمت  1000000',
    ['Enter_House'] = 'رفتن داخل خانه',
    ['Sell_Confirm'] = 'آیا مایل به فروش هسید',
    ['yes'] = 'Yes',
    ['no'] = 'No',
    ['Sold_House'] = 'شما خونه خود را به قیمت  $%s فروختید',
    ['Must_Sell'] = ' شما یک خانه دارید .شما فقط میتوانید یک خانه داشته باشید',
    ['Buy_House_Confirm'] = 'خرید خونه #%s به قیمت $%s?',
    ['Manage_Door'] = 'LifeAgain HOUSE SYSTEM',
    ['Accept'] = 'باز کردن در برای مهمان',
    ['Exit'] = 'خارج شدن از خانه',
    ['Noone_Home'] = 'hich kas dar in khane nist(In Khone Sahab Darad)',
    ['Someone_Knocked'] = 'yek player darkhast darad vared khone shoma shavad. baraye ghabol kardan be dar bravid!',
    ['Let_In'] = 'درخواست ها',
    ['Accept_Player'] = '[ %s ]',
    ['Waiting_Owner'] = 'lotfan montazer bemanid.',
    ['ikea'] = 'IKEA',
    ['Buy_Furniture'] = 'froshghah lavazem khaneghi',
    ...
    ['Furnish'] = 'چیدن وسایل خانه',
    ['Store_Garage'] = 'Press ~INPUT_CONTEXT~ to store the vehicle', 
    ['Re_Furnish'] = 'حذف کردن وسایل خانه',
    ['Remove'] = 'Remove %s (#%s)',
    ['Amount'] = 'How many?',
    ...
    ['bullets'] = 'bullets', 
    ['Rotation'] = 'rotation',
    ['Guests'] = 'mehman ha bayad az khane kharej shavand.',
    ['Garage'] = 'Enter garage',
    ['No_Spawn'] = 'Couldn\'t find a spawnpoint for your house.',
    ['Host_Left'] = 'sabkhone az khone kharej shod va be hamin dalil shoma az khane kharej shodid.',
    ['No_Money'] = 'You don\'t have enough money!',
