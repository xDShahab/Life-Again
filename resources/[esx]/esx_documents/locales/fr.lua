Locales['fr'] = {
    ...
    ['document_delete_failed'] = "Erreur lors de la suppression du document .",
    ['copy_from_player'] = "Vous avez reçu la copie d'un formulaire d'un autre citoyen.",
    ['from_copied_player'] = "Copie du formulaire envoyée au citoyen",
    ['could_not_copy_form_player'] = "Impossible de copier ce formulaire au citoyen.",
