Locales['de'] = {
    ['document_deleted'] = "Dokument wurde gelöschtr.",
    ['document_delete_failed'] = "Dokument löschen fehlgeschlagen.",
    ['copy_from_player'] = "Du erhälst eine Dokumentkopie.",
    ['from_copied_player'] = "Dokument Kopie gegeben",
    ['could_not_copy_form_player'] = "Kann Dokument nicht kopieren.",
