Locales['br'] = {
    ['document_deleted'] = "Documento foi eliminado.",
    ['document_delete_failed'] = "A exclusão do documento falhou.",
    ['copy_from_player'] = "Você recebeu uma cópia do formulário de um jogador.",
    ['from_copied_player'] = "Formulário copiado para o jogador",
    ['could_not_copy_form_player'] = "Não foi possível copiar o formulário para o player.",
