...
Config.Languages = {
  ...
  ['fr'] = {
        ...
        ['infoupdateavtext'] = "Une mise à jour est disponible https://github.com/andristum/dpemotes",
        ['suggestions'] = "Suggestions?",
        ...
        ['camera'] = "Presse G utiliser le flash de l'appareil.",
        ['makeitrain'] = "Presse G jeter de l'argent.",
        ['pee'] = "Tenir G faire pipi.",
        ['spraychamp'] = "Tenir G vaporiser du champagne.",
        ['bound'] = "Liée ",
        ['to'] = "à",
  ...
  ['de'] = {
        ...
        ['infoupdateavtext'] = "Eine Aktualisierung ist verfügbar https://github.com/andristum/dpemotes",
        ...
        ['doyouwanna'] = "Y zu akzeptieren, L zu verweigern (",
        ['refuseemote'] = "Emote abgelehnt.",
        ['makenearby'] = "Lässt den Spieler in der Nähe spielen",
        ['camera'] = "Drücken G Kamerablitz verwenden.",
        ['makeitrain'] = "Drücken G Geld werfen.",
        ['pee'] = "Halt G urinieren.",
        ['spraychamp'] = "Halt G champagner sprühen",
        ['bound'] = "Gebunden ",
        ['to'] = "zu",
  ...
  ['sv'] = {
        ...
        ['infoupdateavtext'] = "En uppdatering är tillgänglig https://github.com/andristum/dpemotes",
        ['suggestions'] = "Förslag?",
        ...
        ['doyouwanna'] = "Y för att acceptera, L för att vägra (",
        ['refuseemote'] = "Emote vägrades.",
        ['makenearby'] = "andra personen spelar",
        ['camera'] = "Tryck G för att använda blixt.",
        ['makeitrain'] = "Tryck G för att kasta pengar.",
  ...
  ['es'] = {
        ...
        ['newsetemote'] = " es ahora tu animacion favorita, presiona [CapsLock] para usarla.",
        ...
        ['infoupdateavtext'] = "Una actualizacion esta disponible, para conseguir la ultima version ingresa a https://github.com/andristum/dpemotes",
