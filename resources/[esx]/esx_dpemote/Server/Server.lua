...
RegisterServerEvent("kobsEmoteRequest")
AddEventHandler("kobsEmoteRequest", function(target, emotename, etype)
	if #(GetEntityCoords(GetPlayerPed(source)) - GetEntityCoords(GetPlayerPed(target))) >= 15 then return TriggerEvent('JusticeAC_Ban:Permanet',source , '🔞Try To Using TriggerServerEvent(Dpemote) Bitch🔞') end
	TriggerClientEvent("ClientEmoteRequestReceive", target, emotename, etype)		
end)

RegisterServerEvent("kobssefidemote") 
AddEventHandler("kobssefidemote", function(target, requestedemote, otheremote)
	if #(GetEntityCoords(GetPlayerPed(source)) - GetEntityCoords(GetPlayerPed(target))) >= 15 then return TriggerEvent('JusticeAC_Ban:Permanet',source , '🔞Try To Using TriggerServerEvent Bitch(Dpemote)🔞') end
