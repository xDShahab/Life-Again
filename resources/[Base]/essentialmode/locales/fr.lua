Locales['fr'] = {
  ...
  ['gave_ammo'] = 'vous donnez ~o~%sx munitions à %s.',
  ['received_ammo'] = 'vous recevez ~o~%sx munitions de %s.',
  ...
  ['threw_weapon_ammo'] = 'you threw 1x %s with ~o~%sx bullets',
  -- Salary related
  ...
  ['cannot_pickup_room'] = 'vous n\'avez plus de place pour %s!',
