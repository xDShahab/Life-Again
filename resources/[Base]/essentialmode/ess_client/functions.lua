...
ESX.ShowNotification = function(msg)
	exports['At_Notfication']:Alert("SUCCESS", msg, 5000, 'success')
end
...
ESX.ShowHelp = function(msg, x, y, z)
...
ESX.TriggerServerCallback = function(name, cb, ...)
	if slm then
		--ESX.ShowNotification('Spam Callback Naknid')
		return
	else
...
ESX.UI.Menu.Open = function(type, namespace, name, data, submit, cancel, change, close)
	TriggerEvent('InteractSound_CL:PlayOnOne','sound', 0.5)
	local menu = {}
