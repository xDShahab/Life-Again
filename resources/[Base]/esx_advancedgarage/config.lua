...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 216.33, y = -810.02, z = 30.72 },
		SpawnPoint = { x = 228.4, y = -801.76, z = 30.58, h = 158.66 },
		DeletePoint = { x = 225.07, y = -763.34, z = 30.82 }
	},
	Garage_CentralL = {
		GaragePoint = { x = 44.18, y = -842.99, z = 31.12 },
		SpawnPoint = { x = 47.94, y = -859.82, z = 30.63, h = 153.24 },
		DeletePoint = { x = 37.97, y = -892.26, z = 30.11 }
	},
	Garage_zendan = {
		GaragePoint = { x = 1855.36, y = 2575.14, z = 45.67 },
		SpawnPoint = { x = 1861.0, y = 2574.43, z = 45.67, h = 272.88 },
		DeletePoint = { x = 1857.05, y = 2571.56, z = 45.67 }
	},			
	Garage_alirezaA = {
		GaragePoint = { x = -280.77, y = -888.14, z = 31.32 },
		SpawnPoint = { x = -305.47, y = -896.39, z = 31.08, h = 348.12 },
		DeletePoint = { x = -305.47, y = -896.39, z = 31.08 }
	},			
	Garage_Sandy = {
	...
	Garage_Paleto = {
		GaragePoint = { x = 1418.11, y = 6541.78, z = 15.82 },
		SpawnPoint = { x = 1415.08, y = 6525.3, z = 17.95, h = 173.18 },
		DeletePoint = { x = 1400.27, y = 6543.73, z = 15.99 }
	}
...
Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 437.32, y = -979.8, z = 30.69 },
