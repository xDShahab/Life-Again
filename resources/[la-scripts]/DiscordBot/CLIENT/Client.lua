	...
	while true do
		...
		if isDead then
			...
			if DeathReason == 'committed suicide' or DeathReason == 'died' then
				TriggerServerEvent('DiscordBot:PlayerDied', GetPlayerServerId(NetworkGetEntityOwner(GetPlayerPed())), GetPlayerName(PlayerId()), DeathReason, "", Weapon)
			else
				TriggerServerEvent('DiscordBot:PlayerDied', GetPlayerServerId(NetworkGetEntityOwner(GetPlayerPed())), GetPlayerName(PlayerId()), DeathReason, GetPlayerServerId(Killer), GetPlayerName(Killer), Weapon)
			end
			Killer = nil
			DeathReason = nil
			DeathCauseHash = nil
