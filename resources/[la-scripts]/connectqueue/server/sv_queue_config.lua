...
Config.Language = {
    ...
    connecting = "\xE2\x8F\xB3Darhal Connect Shodan Be Server LifeAgain..",
    connecting = "\xE2\x8F\xB3Darhal Connect Shodan Be Server LifeAgain...",
    connecting = "\xE2\x8F\xB3Darhal Connect Shodan Be Server LifeAgain....",
    connecting = "\xE2\x8F\xB3Darhal Connect Shodan Be Server LifeAgain.....",
    ...
    steam = "\xE2\x9D\x97 [Queue] Error: moshkeli dar peyda kardan steam ya hwid shoma wojod darad lotfan steam va fivem khod ra restart konid"
}