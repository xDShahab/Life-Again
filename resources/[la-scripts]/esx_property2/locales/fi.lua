Locales['fi'] = {
  ...
  ['rented_for'] = 'sinä vuokrasit kiinteistön hintaan $%s',
  ['purchased_for'] = 'sinä ostit kiinteistön hintaan $%s',
  ['made_property'] = 'sinä teit kiinteistön',
  ['not_enough'] = 'sinulla ei ole tarpeeksi rahaa',
  ['invalid_quantity'] = 'virheellinen määrä',
  ['paid_rent'] = 'sinä maksoit vuokraasi: $%s',
  ['not_enough_in_property'] = 'täällä ei ole enempää tätä itemiä tässä kiinteistössä!',
