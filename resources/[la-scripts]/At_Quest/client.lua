...
Citizen.CreateThread(function()
    while true do
        ...
        if alireza() then
            ESX.ShowHelpNotification('~h~Press [E] To Open Quest')
        end
...
function Queschist()
    ESX.ShowMissionText('Quest Kari Hast Ke Mitonid Ba Ghozashtan Time Va Raftan Be Job Hay Public Mesl Mineri Va .. ')
    Citizen.Wait(8000)
    ESX.ShowMissionText('Azash Pol  Dar Biayardi ')
    Citizen.Wait(3000)
    ESX.ShowMissionText('Va Kar Hai Ke BeShoma Ghofte Shodeh Dar Har Quest Robayad Anjam Bedid Va on Item Haro Bedast Biyarid Be Be Bot Tahvil Bedid.')
end
...
function Initialize(scaleform)
	...
	PushScaleformMovieFunctionParameterString("Quest Level Up Done")
