...
RegisterNetEvent('la_handsup:getSurrenderStatusPlayer')
AddEventHandler('la_handsup:getSurrenderStatusPlayer',function(event,source)
		if handsup then
			TriggerServerEvent("la_handsup:reSendSurrenderStatus",event,source,true)
		else
			TriggerServerEvent("la_handsup:reSendSurrenderStatus",event,source,false)
		end
end)
