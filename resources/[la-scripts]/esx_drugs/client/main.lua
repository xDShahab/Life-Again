...
Citizen.CreateThread(function()
    for k,v in pairs(Config.Peds) do
        ...
        SetPedCanRagdolllFromPlayerImpact(seller, false)
...
AddEventHandler('esx_jk_drugs:selling', function()
    ...
    elseif Config.UseGCPhone then
        if crossing ~= nil then
            ...
            TriggerServerEvent('ST_addons_gcphoneJL:startCall', 'police', "Some shady prick is selling drugs on " .. streetName .. " and " .. crossing, PlayerCoords, {
                PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z },
            })
        else
            TriggerServerEvent('ST_addons_gcphoneJL:startCall', "police", "Some shady prick is selling drugs on " .. streetName, PlayerCoords, {
                PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z },
            })
        end
    else
...
AddEventHandler('esx_jk_drugs:restricted', function()
    ...
    elseif Config.UseGCPhone then
        if crossing ~= nil then
            ...
            TriggerServerEvent('ST_addons_gcphoneJL:startCall', 'police', "Someone entered a Restricted Area at " .. streetName .. " and " .. crossing, PlayerCoords, {
                PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z },
            })
        else
            TriggerServerEvent('ST_addons_gcphoneJL:startCall', "police", "Someone entered a Restricted Area at " .. streetName, PlayerCoords, {
                PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z },
            })
        end
    else
...
AddEventHandler('esx_drugs:hasEnteredMarker', function(zone)
	...
	if zone == "drug_1" then
		...
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Crack besazid'
		CurrentActionData = {}
	elseif zone == "drug_2" then
		CurrentAction     = 'cocke_menu'
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Cocaine besazid'
		CurrentActionData = {}
	elseif zone == "drug_3" then
		CurrentAction     = 'marijuana_menu'
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Marijuana besazid'
        CurrentActionData = {}
    elseif zone == "drug_4" then
		CurrentAction     = 'ephedrine_menu'
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Ephedrine besazid'
        CurrentActionData = {}
    elseif zone == "drug_5" then
		CurrentAction     = 'poppy_menu'
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Teryak besazid'
        CurrentActionData = {}
    elseif zone == "drug_6" then
		CurrentAction     = 'opium_menu'
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Heroine besazid'
        CurrentActionData = {}
    elseif zone == "drug_7" then
		CurrentAction     = 'meth_menu'
		CurrentActionMsg  = 'Dokme ~INPUT_CONTEXT~ ro feshar bedid ta Shishe besazid'
        CurrentActionData = {}
	end
end)
