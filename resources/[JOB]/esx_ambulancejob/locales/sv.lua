Locales['sv'] = {
  ...
  ['revive_complete_award'] = 'du har återupplivat %s och tjärnat %s SEK för dina tjänster, bra jobbat!',
  ...
  ['respawn_bleedout_in'] = 'du kommer att blöda ut om %s:%s\n',
  ['respawn_bleedout_prompt'] = 'håll [E] för att respawna',
  ['respawn_bleedout_fine'] = 'håll [E] för att respawna, kostar %s SEK',
  ['respawn_bleedout_fine_msg'] = 'du betalade %s SEK för att respawna.',
