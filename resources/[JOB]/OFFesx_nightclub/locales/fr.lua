Locales['fr'] = {
  ...
  ['nightclub_wear'] = 'tenue nightclub',
  ...
  ['being_searched'] = 'vous avez été fouiller par le nightclub',
  ...
  -- Notifications
  ['alert_nightclub'] = 'alerte nightclub',
  ['phone_nightclub'] = 'nightclub',
}
