Locales['en'] = {
  ...
  ['being_searched'] = 'you are being searched by the Blackguard',
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['Blackguard_stock'] = 'Blackguard Stock',
  ...
  -- Notifications
  ['alert_Blackguard'] = 'Blackguard alert',
  ['phone_Blackguard'] = 'Blackguard',
}
