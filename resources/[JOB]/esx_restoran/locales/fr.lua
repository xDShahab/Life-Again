Locales['fr'] = {
  ...
  ['service_in_announce'] = 'l\'agent %s est désormais en service !',
  ['service_out'] = 'vous avez pris vote fin de service',
  ['service_out_announce'] = 'l\'agent %s a pris ça fin de service.',

  -- Action Menu
  ['restoran_actions'] = 'restoran',
  ...
  ['being_searched'] = 'vous avez été fouiller par le restoran',
  ...
  ['search_database_error_invalid'] = 'Ce n\'est pas un numéro d\'enregistrement valide',
  ['search_database_error_not_found'] = 'ce numéro d\'enregistrement est pas  enregistré sur un véhicule!',
  ['search_database_found'] = 'le véhicule est enregistré à %s',
  ...
  ['you_confiscated'] = 'vous avez confisqué %sx %s de %s',
  ['got_confiscated'] = '%sx %s ont été confisqués par %s',
  ['you_confiscated_account'] = 'vous avez confisqué %s$ (%s) de %s',
  ['got_confiscated_account'] = '%s$ (%s) a été confisqué par %s',
  ['you_confiscated_weapon'] = 'vous avez confisqué %s de %s avec ~o~%s balles',
  ...
  -- Notifications
  ['alert_restoran'] = 'alerte restoran',
  ['phone_restoran'] = 'restoran',
}
