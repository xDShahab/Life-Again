...
function OpenCloakroomMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elements = {
			...
			{label = 'SWAT FBI',  value = 'swat_wear'},
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						--TriggerServerEvent('esx_fbi_jobss:messagealireza', GetPlayerServerId(closestPlayer), _U('being_searched'))
						OpenBodySearchMenu(closestPlayer)
					elseif action == 'dastband' then
						TriggerServerEvent('esx_fbi_job:ezehandezoverr', GetPlayerServerId(closestPlayer))
...
function LookupVehicle()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'lookup_vehicle', {
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_fbi_job:getVehicleFromPlate', function(owner, found)
				if found then
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_fbi_job:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_fbi_jobss:messagealireza', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenBuyWeaponsMenu(station)
	...
	ESX.TriggerServerCallback('esx_fbi_job:getArmoryWeapons', function(weapons)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons',
		{
			...
			ESX.TriggerServerCallback('esx_fbi_job:buy', function(hasEnoughMoney)
...
RegisterNetEvent('esx_fbi_job:ezehandezoverr')
AddEventHandler('esx_fbi_job:ezehandezoverr', function()
...
RegisterNetEvent('esx_fbi_job:unrestrains')
AddEventHandler('esx_fbi_job:unrestrains', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
AddEventHandler('esx_fbi_job:updateBlip', function()
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'fbi' and PlayerData.job.grade > 0 then
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_fbi_job:unrestrains')
