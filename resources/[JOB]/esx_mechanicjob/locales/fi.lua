Locales['fi'] = {
  ...
  ['mission_canceled']          = 'tehtävä peruutettu',
  ...
  ['not_experienced_enough']    = 'et ole tarpeeksi koulutettu että voit tehdä tätä.',
  ['gas_can']                   = 'kaasupullo',
  ...
  ['vehicle_impounded']         = 'ajoneuvo Takavarikoitu',
  ['must_seat_driver']          = 'sinun pitää olla kuskin paikalla',
  ['must_near']                 = 'sinun pitää olla ajoneuvon lähellä että voit takavarikoida.',
  ['vehicle_success_attached']  = 'ajoneuvo onnistuneesti kytketty!.',
  ['please_drop_off']           = 'vie ajoneuvo korjauspajan pihalle, kiitos.',
  ['cant_attach_own_tt']        = 'Et voi kytkeä omaa hinausautoa',
  ['no_veh_att']                = 'täällä ei ole ajoneuvoa jota kytkeä',
  ['not_right_veh']             = 'tämä ei ole oikea ajoneuvo',
  ['veh_det_succ']              = 'ajoneuvo onnistuunesti irroitettu!',
  ['imp_flatbed']               = 'Toiminto mahdoton! Sinulla pitää olla Flatbed tähän.',
  ['objects']                   = 'objektit',
  ['roadcone']                  = 'kartio',
  ...
  ['hijack_failed']             = 'Tiirikointi epäonnistu',
  ...
  ['not_enough_gas_can']        = 'sinulla ei ole tarpeeksi kaasupulloja.',
  ['assembling_blowtorch']      = 'kasataan Polttoleikkuria...',
  ['not_enough_repair_tools']   = 'sinulla ei ole tarpeeksi korjaus työkaluja.',
  ['assembling_repair_kit']     = 'kasataan Korjauskittiä...',
  ['not_enough_body_tools']     = 'sinulla ei ole tarpeeksi kori työkaluja.',
