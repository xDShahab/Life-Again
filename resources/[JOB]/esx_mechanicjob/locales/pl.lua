Locales['pl'] = {
  ...
  ['must_near']                 = 'musisz być blisko pojazdu aby go odholować.',
  ['vehicle_success_attached']  = 'pojazd przyłączony',
  ['please_drop_off']           = 'proszę odstawić pojazd w garażu',
  ['cant_attach_own_tt']        = 'nie możesz podłączyć własnego holwnika',
  ['no_veh_att']                = 'nie ma pojazdu do podłączenia',
  ['not_right_veh']             = 'to nie jest prawidłowy pojazd',
  ['veh_det_succ']              = 'pojazd odłączony!',
  ['imp_flatbed']               = 'Akcja niemożliwa! Potrzebujesz lawety aby załadować pojazd',
  ['objects']                   = 'objekty',
  ['roadcone']                  = 'pachołek',
  ...
  ['you_do_not_room']           = 'Nie masz wiecej miejsca',
  ...
  ['not_enough_gas_can']        = 'nie posiadasz wystarczająco paliwa w kanistrze.',
