...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elements = {
			...
			{label = 'dar ovordan' , value = 'citizen_wear'},

			{label = 'lebas' , value = 'alireza_wear'},
		...
		elseif data.current.value == 'alireza_wear' then
...
function OpenarteshActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'artesh_actions', {
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						TriggerServerEvent('esx_artesh_jobss:messagealireza', GetPlayerServerId(closestPlayer), _U('being_searched'))
						OpenBodySearchMenu(closestPlayer)
					elseif action == 'dastband' then
						TriggerServerEvent('esx_artesh_job:hawndcufwff', GetPlayerServerId(closestPlayer))
		...
		elseif data.current.value == 'Ekhtar' then
			local elements  = {}
		...
		'default', GetCurrentResourceName(), 'warn_interaction',
		{
			...
			action  = data2.current.value
				...
				TriggerServerEvent('Aliat:warns1','Edare Artesh LifeAgain Shomaro Mohasere Karde , Taslim Shid Ekhtare 1')
			end
			if action == 'warn2' then
					TriggerServerEvent('Aliat:warns1','Edare Artesh LifeAgain Shomaro Mohasere Karde , Taslim Shid Ekhtare 2')
			end
			if action == 'warn3' then
					TriggerServerEvent('Aliat:warns1','Edare Artesh LifeAgain Shomaro Mohasere Karde , Taslim Shid Ekhtare Akhar , Darsurate Taslim Nashodan Mojazat Shoma 2 Barabar Mishavad')
			end
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_artesh_job:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_artesh_jobss:messagealireza', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenBuyWeaponsMenu()
	ESX.UI.Menu.CloseAll()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'Kharid_weapon', {
		title    = "bY wEAPON",
		align    = 'center',
		elements = {
			{label = "Pistol50              --> 100K ", value = "b1"},
			{label = "CombatPistol          --> 100K ", value = "a1"},
			{label = "Advansedrifle         --> 150k ", value = "b2"},
			{label = "combatpdw             --> 110K ", value = "b3"},
			{label = "Carbinerifle          --> 40K ", value = "bbbbs"},
			{label = "specialcarbine        --> 40K ", value = "b6"},
			{label = "Smg                   --> 40K ", value = "b7"},
			{label = "Grip                  --> 40K ", value = "b4"},
			{label = "Stun Gun              --> 40K ", value = "b13"},
			{label = "Tir                   --> 1K ", value = "b14"},
			{label = "Silencer              --> 1K ", value = "b15"},
		...
		if data.current.value == "b1" then
		 TriggerServerEvent('esx_artesh:bypistol50', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b2" then
		  TriggerServerEvent('esx_artesh:byadvansedrifle', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b3" then
		  TriggerServerEvent('esx_artesh:byCombatbtw', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b4" then
			TriggerServerEvent('esx_artesh:bygrip', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "bbbbs" then
			TriggerServerEvent('esx_artesh:bycarbine', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b6" then
			TriggerServerEvent('sx_artesh:byspecial', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b7" then
			TriggerServerEvent('sx_artesh:bysmg', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "a1" then
			TriggerServerEvent('sx_artesh:bycombatpistol', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b13" then
			TriggerServerEvent('sx_artesh:bystungun', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b14" then
			TriggerServerEvent('sx_artesh:byclip', GetPlayerServerId(PlayerId()))
		elseif data.current.value == "b15" then
			TriggerServerEvent('sx_artesh:bysilencer', GetPlayerServerId(PlayerId()))
		end
...
RegisterNetEvent('esx_artesh_job:hawndcufwff')
AddEventHandler('esx_artesh_job:hawndcufwff', function()
